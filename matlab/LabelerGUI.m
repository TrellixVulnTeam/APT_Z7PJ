...
handles.menu_go_gt_frames = uimenu('Parent',handles.menu_go,...
  ...
  'Separator','on',...
  'Checked','off');
handles.menu_go_load_lbl_suggestions = uimenu('Parent',handles.menu_go,...
  'Callback',@(hObject,eventdata)LabelerGUI('menu_go_load_lbl_suggestions_Callback',hObject,eventdata,guidata(hObject)),...
  'Label','Load label suggestions...',...
  'Tag','menu_go_load_lbl_suggestions',...
  'Separator','off',...
  'Checked','off', ...
  'Visible','on');
moveMenuItemAfter(handles.menu_go_load_lbl_suggestions,handles.menu_go_nav_prefs);
...
function menu_go_load_lbl_suggestions_Callback(hObject,eventdata,handles)
lObj = handles.labelerObj;
loadLblSuggestionsUI(lObj);
